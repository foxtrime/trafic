    ...
    <div class="x_content">
        ...
        <div class="x_panel ">
            <div class="x_content">
                ...
                <form id="frm_user" class="form-horizontal form-label-left" method="post" action="{{ url('categoria')}}">
                {{ csrf_field() }}

                <div class="form-group row">
                    <label for="categoria" class="col-md-2 col-form-label text-md-right">Nome da Categoria</label>
                    <div class="col-md-7">
