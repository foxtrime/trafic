    ...
    <div class="x_content">
        ...
        <div class="x_panel ">
            <div class="x_content">
                ...
                <form id="frm_user" class="form-horizontal form-label-left" method="post" action="{{ url('clima')}}">
                {{ csrf_field() }}

                <div class="form-group row">
                    <label for="clima" class="col-md-2 col-form-label text-md-right">Nome do Clima</label>
                    <div class="col-md-7">
	...
	<script type="text/javascript">
        $(document).ready(function(){
			...
			$("#btn_voltar").click(function(){
				...
				window.location.href = "{{ URL::route('clima.index') }}"; 
			});
