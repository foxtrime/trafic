    ...
    <div class="x_content">
        ...
        <div class="x_panel ">
            <div class="x_content">
                ...
                <form id="frm_user" class="form-horizontal form-label-left" method="post" action="{{ url('transportado')}}">
                {{ csrf_field() }}

                <div class="form-group row">
                    <label for="transportado" class="col-md-2 col-form-label text-md-right">Nome Transportado</label>
                    <div class="col-md-7">
	...
	<script type="text/javascript">
        $(document).ready(function(){
			...
			$("#btn_voltar").click(function(){
				...
				window.location.href = "{{ URL::route('transportado.index') }}"; 
			});
