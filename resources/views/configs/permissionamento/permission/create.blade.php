    ...
    <div class="x_content">
        ...
        <div class="x_panel ">
            <div class="x_content">
                ...
                <form id="frm_permission" class="form-horizontal form-label-left" method="post" action="{{ route('permission.store')}}">
                {{ csrf_field() }}

                <div class="form-group row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="name" class="text-md-right">Nome da Permissão</label>
	...
	<script type="text/javascript">
        $(document).ready(function(){
			...
			$("#btn_voltar").click(function(){
				...
				window.location.href = "{{ URL::route('permission.index') }}"; 
			});
